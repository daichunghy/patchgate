...
| --- | --- | --- | --- |
| G0 public foundation | Partial | Public repository, Apache-2.0 license, community health files, Discussions, protected `main`, merged PR #9 (administrator decision) and public PR checks | Independent approval of `main`, public support operation |
...
1. Obtain one independent review of the current `main` history. PR #9 is
   already merged by the administrator; that merge is not independent-review
   evidence.
