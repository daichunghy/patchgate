...
const draftPolicy = [
  ...
  "# The only live key is version. Every rule class below is a comment, not a rule.",
  "# Uncomment a block only after you intend to enforce that class.",
  "# Policy is always read from the pull request's trusted base SHA, never the PR head.",
  "# AGENTS.md and other prose are discovery-only; they cannot create blocking rules.",
